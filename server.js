...
· 💎 饰品（含美甲美睫）：**每条一句，整块最多四句**。给材质/款式即可，绝不许解释半天为什么。
· 🔢 生命灵数：**最多两句**（大师数照写死文案那段，但也别再额外展开）。绝不许把一个数的含义换三种说法重复（如9别"博爱""奉献""格局"说三遍）。
· 🧭 方位+💰财位：**各一句**。"多往X走更顺、求财往Y走"，完。
...
${sex==="女"?`【🔴本命妆造·只给女生·🔴极简·每条就一句·绝不展开】女性盘在"幸运饰品"里【按这个顺序：①石头饰品（上面那套）②美甲 ③美睫】，三条各一句、干脆利落，整块绝不超过四五句，注水即失败：
· 💅 **本命美甲**：用主色，形状/风格按【最旺元素】硬选（不许瞎判）：火→尖杏仁·撞色；土→方圆·裸色；风→短圆·简约；水→椭圆·珠光晕染。例"一套〈主色〉椭圆珠光甲"。
· 👁 **本命美睫**：按【金星星座元素】硬选（不许瞎判）：火→浓密上扬放电；土→自然加密精致；风→灵动分段俏皮；水→卷翘水润含情目。例"卷翘含情款睫"。
...
两个方位都要给，分开讲清楚（一个管整体顺、一个管财），简短贴心，一两句带过。
