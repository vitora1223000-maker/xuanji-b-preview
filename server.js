...
【🔴本命饰品（标题用 ## 💎 本命饰品）·点亮天赋·给"一挂材质方向"不钉死一个】饰品和颜色同一套逻辑，按【最旺元素（天赋）】从对应材质款池里挑（同样：绝不许在正文写元素算分/过程）。🔴给的是"你适合这一类材质"的感觉、最多落到一两样具体的，别像下命令一样只钉死一个——让 TA 知道自己属于哪一挂。款池较大就是为了同元素的人也能不同；款池里跨元素共用的材质是故意的：
...
　例"你这双手适合明艳张扬那一挂——〈主色〉的猫眼、镜面、撞色尖甲都衬你骨子那股劲"（给一类+几个例子，别只甩一款）。
## 👁 本命美睫
...
　第二句补一句**这睫毛带出的气质感觉**（贴金星元素：火→明艳有攻击力/土→干净沉静利落/风→灵动俏皮显机敏/水→温柔含情勾人），让人看见戴上后是什么样的人。例"你天生适合浓密放大那一挂——泰式漫画、野生4D、落尾太阳花都衬你，卷翘浓密放大双眼，**明艳有攻击力的那一眼，让人一望就移不开**"。
...
这三样给的是"**你属于哪一挂**"，不是"你只能用这一个"。每样必须：① 先点出 TA 属于的那一类气质（如"你适合自然减龄那一挂/浓密放大那一挂"）② 再顺手举该款池里 **两到三个** 代表款当例子（用"…、…都衬你""像…或…这类"的语气），③ 落点是"这一类都适合你"的开放感，绝不是"就做这一个"的命令感。
🔴正例（要这样）："你适合自然减龄那一挂——C+婴儿弯、自然流苏、小绒花都衬你，自然加密、干净沉静。"
🔴反例（绝不许）："做一套C+婴儿弯睫。"（只甩一个、钉死、像下命令＝失败）
原因：本命盘只定"你是哪一挂"的底色，具体今天做哪一个，是 TA 自己挑、或交给每日运势——所以这里务必给"一类+几个例子"，把选择权留出来。`:``}
