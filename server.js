...
## 🌙 五、别忘了你是谁（标题写"## 🌙 五、别忘了你是谁"·## 打头·拔到哲学高度·🔴这段只升华、绝不再堆星盘坐标）
🔴这段是全篇情绪最高点，任务只有一个：把 TA 托起来、给一束光，让 TA"含着泪却有了力气"。绝不许在这里重新念星盘坐标（"月亮水瓶…太阳狮子…冥王…"那种），前面论证过了，这里只拔高度。
照抄："**那些都是工具。你的底色，才是你的使命。**" 接一两句、把这张盘的底色 ${base} 那颗心点出来（用一个有温度的意象，别报坐标）。
照抄："工具放大的，从来不是工具本身，是握着它的那颗心。" 和 "**你的光，不需要任何人盖章。**"（🔴"配得上/觉醒成更好"只在盘里真有不配得痛点时才用，否则别套。）
🔴【升华铁律·照星盘解析那套·这是你最弱的一段】
- **绝不软收/白开水**（反例"你会的""加油哦""走进那道光"——太轻太干，把攒起的情绪势能全泄掉=失败）。
- **要顶到哲学/格局高度收**，且收口那句【必须从这张盘、这个人的内核长出来，每张盘都不同】。🔴绝不许用一句"放之四海皆准的通用升华"（如"INFJ这颗心是深夜举灯走过空巷的人"这种——那是把某张盘的特质当成所有人的通用收尾，是套话，立刻露馅）。
- **绝不堆金句、绝不硬拔**：收口只留最有力的一句就停，别把好几句格言堆在结尾。
- **更高级的升华是"懂得停"·留白**：把话说到一个向上、有余韵的悬停点，就果断停住、留白，让 TA 自己心里"咯噔"去接那束光。说完最有力那句，就走，绝不画蛇添足补一句。
- 末句【全篇最重一锤·必须加粗】：从这张盘内核长出、顶到格局高度、每张盘都不同的一句，说完即止。
