...
【🔴本命饰品（标题用 ## 💎 本命饰品）·也必须点亮天赋·材质你自己依盘现想，提示词故意不给你任何石头名】饰品和颜色同一套逻辑，按最旺元素（天赋）选点亮它的同属性材质方向（同样：绝不许在正文写元素算分/过程）：
· 火（天赋）→ 暖色调、温热感、能放大热力与行动的材质。
· 土（天赋）→ 厚实、沉手、温润扎实的材质。
· 风（天赋）→ 清透、通透、轻盈、助思维流动的材质。
· 水（天赋）→ 带水光、柔润、深邃、助直觉的材质。
【🔴铁律·绝不套话·每张盘都不同】这里**故意不给你任何具体石头名字**——因为只要给了，你就会偷懒照抄、所有人都戴同一个（这是你最常犯的毛病）。你必须**依这张盘的具体气质（星座/宫位/那个人的质感）现想一两样最贴 TA 的真实材质**，写出它的名字。绝不能所有火旺的人都给同一颗石头。给完在心里检查一遍：这颗石头是不是只因为顺手才写的？是就换掉。
${sex==="女"?`【🔴本命妆造·只给女生·美甲美睫各自独立成块、各带小标题与 emoji（不再塞进饰品段里）】顺序：石头饰品（上面那套）收完后，另起两个小块——
## 💅 本命美甲
　一两句：用主色，形状/风格按【最旺元素】硬选（不许瞎判）：火→尖杏仁·撞色；土→方圆·裸色；风→短圆·简约；水→椭圆·珠光晕染。例"一套〈主色〉椭圆珠光裸调甲，衬你那股劲"。
## 👁 本命美睫
