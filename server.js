...
🔴【格式铁律·用户的眼睛只抓加粗句·没加粗=没人看见】
- 每段【至少 1～2 句】最戳人的结论用 **加粗**（人类扫读只看得见加粗的）。加粗只给戳心结论/金句，星座坐标凭据不加粗，型号字母可加粗。
- 每段最狠那句金句可单独用 > 引用另起一行，让它跳出来。
...
② 最弱的一面=${infTxt}——就一句陈述"这是你最不费力够到的那一面"，立刻转下一步。🔴绝不默认 TA 为此自卑/不配得/痛苦（不是每个人都自卑），盘里没痛点坐标支撑就只客观陈述、不替 TA 安情绪。
