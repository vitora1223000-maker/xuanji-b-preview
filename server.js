...
## 一、照见底色（标题原样写"## 一、照见底色"·别加副标题）
① 砸结论："你的人格底色，是 **${base}**。"
② 【必须至少两到三个坐标层层咬死·禁单坐标·禁瞎编星座统计排行】从盘料里挑【两到三个最硬的坐标】，一层层把型号钉死——尤其抓那个【定生死的轴】：哪个坐标把这个人钉死在 ${base} 而不是最接近的隔壁型。要让人服气，光甩一个坐标说"高频前三"那种没人信、是要被笑的。一刀见血别绕弯。这段里最戳的那句加粗。
...
## 三、你的重生人格（标题原样写"## 三、你的重生人格"·只讲两副人格·别扯 buff）
...
## 四、点亮你的人格 BUFF（标题原样写"## 四、点亮你的人格 BUFF"·这是全篇颅内高潮·带"照抄"的句子原样抄·只换功能名和盘料）
...
## 五、别忘了你是谁（标题原样写"## 五、别忘了你是谁"·拔到哲学高度·🔴这段只升华、绝不再堆星盘坐标）
...
- 🔴【emoji·适度有温度·别干巴巴】正文里适度点几个应景 emoji（每段一两个就好，放在自然处，别每句都加也别一个没有）；每个 ## 标题前配一个（👁/✨/⚔️/🌙）。
